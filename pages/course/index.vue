      ...
      <section class="c-sort-box">
        ...
        <div class="mt40">
          ...
          <section class="no-data-wrap" v-if="data.total==0">
            ...
            <span class="c-666 fsize14 ml10 vam">没有相关数据，魔法小精灵正在努力整理中...</span>
          </section>
          <!-- /无数据提示 结束-->
              ...
              <li v-for="course in data.items" :key="course.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    <img :src="course.cover" class="img-responsive" :alt="course.titile">
                    <div class="cc-mask">
...
export default {
  ...
  methods:{
    ...
    searchOne(id, index){
      ...
      //获取该一级分类下的二级分类
      course.getTwoSubject(id)
        .then(response=>{
          this.subSubjectList=response.data.data.twoSubjectList
        })
